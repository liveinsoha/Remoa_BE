...
public class JwtTokenProvider {
    ...
    public String createToken(String nickname) { //nickname 받음
        Claims claims = Jwts.claims().setSubject(nickname); // JWT payload에 저장되는 정보 단위
        claims.put("nickname", nickname); // key/ value 쌍으로 저장
