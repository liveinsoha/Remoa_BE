...
public class MessageUtils {
    ...
    public static final String ERROR = "요청 처리 중 오류가 발생하였습니다.";
    public static final String NOT_FOUND = "요청한 리소스를 찾을 수 없습니다.";
    public static final String UNAUTHORIZED = "인증 필요합니다. 토큰을 제공해주세요";
    public static final String FORBIDDEN = "권한이 없습니다. ADMIN 계정만 접근 가능합니다 ";
